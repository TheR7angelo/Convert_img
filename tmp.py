...
#     match geom:
#         case "<g":
#             line, name, tab, fill, color_group = getGroup(line=line, name=name, tab=tab, fill=fill, geom=geom,
#                                                           color_group=color_group)
#         case "<path":
#             line, name, tab, fill = getPath(line=line, name=name, tab=tab, fill=fill, geom=geom,
#                                                          color_group=color_group)
#         case "<rect":
...
#                 #     connector.commit()
#
#                 connector.insert_style(key=key, type_value=sub_key, value=value)
#
#             fill[key] = tmp.copy()
#
#     return fill
...
#             _, name, fill, _, st = setColors(line=row, name=name, fill=fill)
#
#             row = f"class={st}"
#
#         row = row.replace('"', "")
...
#
#         if balise_geom := next(
#                 (x for x in ["<g", "<path", "<rect", "<polygon", "<text", "<circle", "<ellipse"] if x in line), False):
#             line, name, tab, fill, color_group = getGeom(line=line, name=name, tab=tab, fill=fill, geom=balise_geom,
#                                                          color_group=color_group)
#             xaml.append(line)
#
#         start = index
...
#
#         with open(f"{directory}/{file_name}.xaml", "w", encoding='utf-8') as output:
#             output.write(truc)
